...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        true_photo = PIL.Image.open("images/true.png")
        true_image = ImageTk.PhotoImage(true_photo)
        self.true_button = Button(command=self.true_pressed, image=true_image, highlightthickness=0)
        self.true_button.grid(row=2, column=0)

        false_photo = PIL.Image.open("images/false.png")
        false_image = ImageTk.PhotoImage(false_photo)
